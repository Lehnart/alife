...
#define BIRD_COLLISION_ACCELERATION 1.f

#define BIRD_ALIGNMENT_RADIUS 25
#define BIRD_ALIGNMENT_ACCELERATION 0.5f

#define BIRD_COHESION_RADIUS 50
#define BIRD_COHESION_ACCELERATION 0.25f
